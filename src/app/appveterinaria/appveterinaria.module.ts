...
import { SubnabvarComponent } from './components/subnabvar/subnabvar.component';
...
@NgModule({
  declarations: [
    ...
    CitasComponent, AgregarclienteComponent, ListaclientesComponent, VerclienteComponent, DataclienteComponent, DatamascotaComponent, 
    MessageComponent, ListamascotasComponent, VermascotaComponent, AgregarmascotaComponent, MasdetallesComponent, DetallesmascotaComponent, 
    VisitaComponent, VacunaComponent, ListavisitasComponent, AgregarcitaComponent, ListacitasComponent, VentaComponent, NuevaventaComponent, 
    ListaventasComponent, ArticuloComponent,InventarioComponent, ListaproductosComponent, PorcategoriaComponent, PorproveedorComponent, 
    NuevoproductoComponent, ProveedoresComponent, ListaproveedoresComponent, NuevoproveedorComponent, UsuariosComponent, ListausuariosComponent, 
    NuevousuarioComponent, ReportesComponent, VentasComponent, IngresosComponent, VisitasComponent, PormesesComponent, DehoyComponent, 
    NuevacategoriaComponent, PerfilComponent, UsuarioComponent, VerproductoComponent, FechaPipe, VerproveedorComponent, BusquedaComponent,
    SubnabvarComponent
  ],
  imports: [
    CommonModule,
